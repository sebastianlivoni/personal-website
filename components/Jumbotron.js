      ...
      <div className="flex justify-center items-center h-screen tracking-wide">
        ...
        <div className="max-w-sm sm:max-w-xl mx-12 z-30">
          ...
          <h5 className="text-md sm:text-xl font-light text-gray-700 dark:text-white">
            I&apos;m Sebastian, a {greogorianAge()} year old upcoming full stack
            developer with a deep desire to develop in JavaScript and Swift.
            Explore this page to learn more about my journey.
          </h5>
        </div>
      </div>
    </section>
