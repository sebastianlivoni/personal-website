      ...
      <div className="pt-6 md:p-12 text-center md:text-left space-y-4 dark:text-white">
        ...
        <blockquote>
          <p className="text-lg font-normal mt-10">
            I am currently a student at Aalborg University, Denmark. I enjoy
            solving{" "}
        ...
        <blockquote>
          <p className="text-lg font-normal mt-10">
            Other than that, I love exploring web designs and programming stuff.
            I&apos;m a huge consumer of reddit too.
          </p>
        </blockquote>
        <blockquote>
          <p className="text-lg font-normal mt-10">
            Outside of University I enjoy playing football and computer games
            such as Minecraft, FIFA and sometimes simulation games.
          </p>
        </blockquote>
