          ...
          <div className="flex justify-between">
            ...
            <div className="flex items-center space-x-1 font-medium">
              <div className="hidden md:block">
                ...
                <NavLink to="/" className="mr-3 text-transparent bg-clip-text bg-gradient-to-br from-black to-black dark:from-white dark:to-white dark:hover:from-pink-400 dark:hover:to-red-600" activeClassName="dark:from-white dark:to-white dark:from-pink-400 dark:to-red-600">Home</NavLink>
                ...
                <NavLink to="#contact-form" className="text-transparent bg-clip-text bg-gradient-to-br from-black to-black dark:from-white dark:to-white dark:hover:from-pink-400 dark:hover:to-red-600">Contact</NavLink>
              </div>
